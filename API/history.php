...
<body>
  ...
  <div id="menu">
  <a href="index.php"><div class="item" >Nouvelles alertes</div></a>
   <a href="history.php">  <div class="item" id="selected"> Historique</div></a>
...
<?php
  ...
  $db->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
    ...
    $req = $db->prepare('SELECT * FROM alerts WHERE 1');
